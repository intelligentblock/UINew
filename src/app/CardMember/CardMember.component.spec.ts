...
describe('CardMemberComponent', () => {
  ...
  let mockCardMemberService;
  let mockDataService

  beforeEach(async(() => {

    mockCardMemberService = sinon.createStubInstance(CardMemberService);
    mockCardMemberService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CardMemberService, useValue: mockCardMemberService },
